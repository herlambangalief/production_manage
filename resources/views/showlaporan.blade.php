    ...
    <div class="container-fluid py-4">
        <div class="card">
            <div class="card-header pb-0 px-3">
                <h6 class="mb-0">{{ __('Edit Laporan Produksi') }}</h6>
            </div>
            <div class="card-body pt-4 p-3">
                <form action="{{route ('laporan.update',$laporan->id_laporan_produksi)}}" method="POST" role="form text-left">
                    @csrf
                    @if($errors->any())
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.name')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="date" placeholder="" id="user-name" name="tanggal" value="{{$laporan->tanggal}}">
                                        @error('name')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="id_material" class="form-control">
                                    <option value="{{$laporan->material->id_material}}">{{$laporan->material->nama_barang}}</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="@error('user.phone')border border-danger rounded-3 @enderror">
                                    <select name="id_proses" class="form-control">
                                        <option value="{{$laporan->proses->id_proses}}">{{$laporan->proses->nama_proses}}</option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="id_tonase" class="form-control">
                                        <option value="{{$laporan->tonase->id_tonase}}">{{$laporan->tonase->nama_tonase}}</option>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.phone')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="number" value="{{$laporan->jumlah_sheet}}" id="number" name="jumlah_sheet">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="id_operator" class="form-control">
                                        @foreach($operator as $op)
                                            <option value="{{$laporan->operator->id_operator}}">{{$laporan->operator->nama_operator}}</option>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.phone')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="time" id="number" name="jam_mulai" value="{{$laporan->jam_mulai}}">
                                        @error('phone')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="user.phone" class="form-control-label">{{ __('Jumlah Jam') }}</label>
                                <div class="@error('user.phone')border border-danger rounded-3 @enderror">
                                    <input disabled="" class="form-control" type="time" id="number" value="{{$laporan->jumlah_jam}}">
                                        @error('phone')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.phone')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="number" id="number" name="jumlah_ok" value="{{$laporan->jumlah_ok}}">
                                        @error('phone')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.location') border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="number" id="name" name="jumlah_ng" value="{{$laporan->jumlah_ng}}">
                                </div>
                            </div>
                        </div>
                    </div>
