    ...
    <div class="container-fluid py-4">
        <div class="card">
            <div class="card-header pb-0 px-3">
                <h6 class="mb-0">{{ __('Edit Finish Good') }}</h6>
            </div>
            <div class="card-body pt-4 p-3">
                <form action="{{route ('finish.update',$finish->id_finishgood)}}" method="POST" role="form text-left">
                    @csrf
                    @if($errors->any())
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="id_material" class="form-control">
                                            <option value="{{$finish->material->id_material}}">{{$finish->material->nama_barang}}</option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.location') border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="number" id="name" name="jumlah" value="{{$finish->jumlah}}">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="id_customer" class="form-control">
                                            <option value="{{$finish->customer->id_customer}}">{{$finish->customer->nama_customer}}</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="@error('user.phone')border border-danger rounded-3 @enderror">
                                    <select name="qc" class="form-control">
                                        <option value="{{$finish->qc}}">{{$finish->qc}}</option>
                                        <option value="&#10004;">&#10004;</option>
                                        <option value="&#10006;">&#10006;</option>
                                    </select>
                                </div>
